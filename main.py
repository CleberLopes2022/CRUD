...
def atualizar():
    try:
        ...
        b_confirmar= Button(frame_baixo, command=update, width=10,text='Confirmar', font=('Ivy 7 bold'), bg=co2, fg=co1,relief='raised', overrelief='ridge')
...
def deletar():
    try:
        ...
        messagebox.showinfo('Sucesso', 'Os dados forma deletados com sucesso!!!')
...
#Nome
l_nome= Label(frame_baixo, text='Nome *',anchor=NW, font=('Ivy 13 bold'), bg=co2, fg=co4,relief='flat')
l_nome.place(x=10, y=10)
e_nome= Entry(frame_baixo, width=45, justify='left',relief='solid')
e_nome.place(x=15, y=40)

#Email
l_email= Label(frame_baixo, text='Email *',anchor=NW, font=('Ivy 13 bold'), bg=co2, fg=co4,relief='flat')
l_email.place(x=10, y=70)
e_email= Entry(frame_baixo, width=45, justify='left',relief='solid')
e_email.place(x=15, y=100)

# Telefone
l_telefone= Label(frame_baixo, text='Telefone *',anchor=NW, font=('Ivy 13 bold'), bg=co2, fg=co4,relief='flat')
...
# botao inserir
b_inserir= Button(frame_baixo,command=inserir, width=10, text='Inserir', font=('Ivy 9 bold'), bg=co6, fg=co1,relief='raised', overrelief='ridge')
b_inserir.place(x=15, y=340)

# botao Atualizar
b_atualizar= Button(frame_baixo, command=atualizar,width=10, text='Atualizar', font=('Ivy 9 bold'), bg=co2, fg=co1,relief='raised', overrelief='ridge')
b_atualizar.place(x=110, y=340)

# botao Deletar
b_deletar= Button(frame_baixo, command=deletar, width=10,text='Deletar', font=('Ivy 9 bold'), bg=co7, fg=co1,relief='raised', overrelief='ridge')
